<script>
    ...
    export let tabs = [
        ...
        { name: "Blog", link: "https://8bitaurum.blogspot.com/" },
        // { name: "Contact", link: "" },
        // {name: '', link: ''},
    ];
</script>
...
>
    <h1 class="font-medium">
        <b class="font-bold poppins text-lg">8BitAurum</b>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        {#each tabs as tab, index}
            <a
                href={tab.link}
                class="duration-200 hover:text-teal-400"
        ...
        >
            ...
            />
            <a href="mailto:aurumbyte.dev@proton.me" class="relative z-9">Get in touch</a>
        </button>
    </div>
</header>
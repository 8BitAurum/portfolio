...
<a
    href={step.href}
    target="_blank"
    class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-teal-700 text-center cursor-pointer group hover:border-teal-400 duration-200"
>
    <div
    ...
    <div class="flex-1 flex justify-betweeen gap-4 items-end">
        ...
        >
            <p class="z-4 p-1 text-2xl fa-brands fa-github" />
        </div>
    </div>
</a>